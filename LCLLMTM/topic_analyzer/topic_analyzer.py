...
def main():
    ...
    # 2. 数据集列表
    datasets = [
        "C:/Users/1/Desktop/TopMost/LCLLMTM/data4LCLLM/NYT_sampled.csv",
        # "/data/xuxuan/TopMost/LCLLMTM/data4LCLLM/20NG_Dataset_final.csv",
        # "/data/xuxuan/TopMost/LCLLMTM/data4LCLLM/IMDB_Dataset.csv",
        # "/data/xuxuan/TopMost/LCLLMTM/data4LCLLM/NeurIPS_Dataset_processed.csv",
        # "/data/xuxuan/TopMost/LCLLMTM/data4LCLLM/WikiText_Dataset.csv",
    ]
      #免费models，用于测试
#     models = [
...
# ]
    ...
    # 4. 输出目录
    outdir = "C:/Users/1/Desktop/TopMost/LCLLMTM/LLM_response_results"
